...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js170');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/p1000242-717.jpg':'images/p1000242-478.jpg'):'images/p1000242-239.jpg');
var e=document.querySelector('.js171');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/p1000247-720.jpg':'images/p1000247-480-1.jpg'):'images/p1000247-240.jpg');
var e=document.querySelector('.js172');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/p1010095-720.jpg':'images/p1010095-480-1.jpg'):'images/p1010095-240.jpg');
var e=document.querySelector('.js173');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/p1010096-717.jpg':'images/p1010096-478.jpg'):'images/p1010096-239.jpg');

};
if(!window.HTMLPictureElement){r();}
js169=new Plyr('.js169 video',{iconUrl:'css/plyr.svg',blankUrl: 'css/blank.mp4',controls:['play-large','play','progress','current-time','mute','volume','fullscreen'],storage:{enabled:false}});
js169.volume=0.8;
ldsrc('.js175');ldsrcset('.js176 source');
});