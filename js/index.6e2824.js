...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js2');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/p1000435-1440.jpg':'images/p1000435-960.jpg'):'images/p1000435-480.jpg');};
if(!window.HTMLPictureElement){r();}
js1=new Plyr('.js1 video',{iconUrl:'css/plyr.svg',blankUrl: 'css/blank.mp4',controls:['play-large','play','progress','current-time','mute','volume','fullscreen'],storage:{enabled:false}});
js1.volume=0.8;
