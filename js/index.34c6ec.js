...
js22.volume=0.8;
js24=new Plyr('.js24 video',{iconUrl:'css/plyr.svg',blankUrl: 'css/blank.mp4',controls:['play-large','play','progress','current-time','mute','volume','fullscreen'],storage:{enabled:false}});
js24.volume=0.8;
...
js25.volume=0.8;
ldsrc('.js5');ldsrcset('.js26 source');ldsrc('.js6');ldsrcset('.js27 source');ldsrc('.js7');ldsrcset('.js28 source');ldsrc('.js8');ldsrcset('.js29 source');ldsrc('.js9');ldsrcset('.js30 source');ldsrc('.js10');ldsrcset('.js31 source');ldsrc('.js11');ldsrcset('.js32 source');ldsrc('.js13');ldsrcset('.js33 source');ldsrc('.js14');ldsrcset('.js34 source');ldsrc('.js15');ldsrcset('.js35 source');ldsrc('.js16');ldsrcset('.js36 source');ldsrc('.js17');ldsrcset('.js37 source');ldsrc('.js18');ldsrcset('.js38 source');ldsrc('.js19');ldsrcset('.js39 source');ldsrc('.js23');ldsrcset('.js40 source');
});