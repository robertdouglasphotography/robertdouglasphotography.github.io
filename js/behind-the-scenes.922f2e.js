...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js221');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/p1000242-717.jpg':'images/p1000242-478.jpg'):'images/p1000242-239.jpg');
var e=document.querySelector('.js222');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/p1000247-720.jpg':'images/p1000247-480-1.jpg'):'images/p1000247-240.jpg');
var e=document.querySelector('.js223');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/p1010095-720.jpg':'images/p1010095-480-1.jpg'):'images/p1010095-240.jpg');
var e=document.querySelector('.js224');e.setAttribute('src',(dpi>1)?((dpi>2)?'images/p1010096-717.jpg':'images/p1010096-478.jpg'):'images/p1010096-239.jpg');

};
if(!window.HTMLPictureElement){r();}
js220=new Plyr('.js220 video',{iconUrl:'css/plyr.svg',blankUrl: 'css/blank.mp4',controls:['play-large','play','progress','current-time','mute','volume','fullscreen'],storage:{enabled:false}});
js220.volume=0.8;
ldsrc('.js226');ldsrcset('.js227 source');
});